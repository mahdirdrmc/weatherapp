...
function getweather(data){
  ...
  document.querySelector(".location-city").innerHTML = "আজকের আবহাওয়া-" + name;
  ...
  document.querySelector(".weather-description").innerHTML = "আকাশের অবস্থা: " + description;
  document.querySelector(".humidity").innerHTML = "আর্দ্রতা: " + humidity + "%";
  document.querySelector(".wind").innerHTML = "বাতাসের বেগ: " + speed + " কিমি/ঘণ্টা";
...
function citynotfound(data){
  document.querySelector(".location-city").innerHTML = "শহর পাওয়া যায় নি";
  document.querySelector(".temperature-degree").style.position = "absolute";
  document.querySelector(".temperature-degree").style.visibility = "hidden";
  document.querySelector(".humidity").style.position = "absolute";
  document.querySelector(".humidity").style.visibility = "hidden";
  document.querySelector(".wind").style.position = "absolute";
  document.querySelector(".wind").style.visibility = "hidden";
  document.querySelector(".weather-description").visibility = "hidden";
}
